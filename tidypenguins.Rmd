...
```{r}
title <- grobTree(textGrob("Penguins Mass (g)",
                             x = 0.1, y = 0.9, hjust = 0,
                             gp = gpar(col = "black",
                                       fontsize = 12,
...
facetedgraph<-ggplot(pengs, aes(x=body_mass_g, y= species, fill=sex))+
                  ...
                  theme(panel.grid.major.y = element_blank(),
                       panel.grid.major.x = element_blank(),
                       panel.grid.minor = element_blank(),
                       plot.background = element_rect(fill = "white", color = "aliceblue"),
                       panel.background = element_rect(fill = "white",color="aliceblue"),
                       axis.ticks.y =element_blank(),
                       axis.text.y = element_blank(),
                       legend.position = "none",
