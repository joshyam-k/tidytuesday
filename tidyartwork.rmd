...
artwork <- artwork_raw %>% 
  mutate(
    artist = case_when(
      artist == "British (?) School" ~ "British School",
      artist == "British School 18th century" ~ "British School",
      artist == "British School 19th century" ~ "British School",
      artist == "British School 17th century" ~ "British School",
      artist == "British School 16th century" ~ "British School",
      artist == "British (?) School 19th century" ~ "British School",
      artist == "?British School" ~ "British School"
      T ~ artist
      )
